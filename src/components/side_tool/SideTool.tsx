...
function Tools({ canvas }: { canvas: fabric.Canvas }) {
  ...
  const handleDeleteObject = useCallback(
    (e: fabric.CanvasEvents['selection:created']) => {
  ...
  useEffect(() => {
    ...
    canvas.defaultCursor = 'default'; // 커서 모양 초기화
  ...
  return (
    <div className={classes.tool_wrap}>
      ...
      <button
        ...
        className={`${classes.tool_button} ${activeTool === 'select' ? classes.selected : undefined}`}
      >
        <img src={cursorIcon} />
      </button>
      <button
        title='배경색'
        onClick={handleSelectFillClick}
        className={`${classes.tool_button} ${activeTool === 'fill' ? classes.selected : undefined}`}
      >
        <img src={fillIcon} />
      </button>
      <button
        ...
        className={`${classes.tool_button} ${activeTool === 'pen' ? classes.selected : undefined}`}
      >
        <img src={brushIcon} />
      </button>
      <button
        ...
        className={`${classes.tool_button} ${activeTool === 'text' ? classes.selected : undefined}`}
      >
        <img src={textIcon} />
      </button>
      <button
        ...
        className={`${classes.tool_button} ${activeTool === 'delete' ? classes.selected : undefined}`}
      >
        <img src={eraserIcon} />
      </button>
      {activeTool === 'pen' && (
        <div className={classes.sub_tool_wrap}>
          ...
          >
            <span
              className={`${classes.palette} ${brush?.color === '#ff0000' ? classes.selected : undefined}`}
          ...
          >
            <span
              className={`${classes.palette} ${brush?.color === '#ffff00' ? classes.selected : undefined}`}
          ...
          >
            <span
              className={`${classes.palette} ${brush?.color === '#007700' ? classes.selected : undefined}`}
          ...
          >
            <span
              className={`${classes.palette} ${brush?.color === '#0000ff' ? classes.selected : undefined}`}
          ...
          >
            <span
              className={`${classes.palette} ${brush?.color === '#880088' ? classes.selected : undefined}`}
          ...
          >
            <span
              className={`${classes.palette} ${brush?.color === '#000000' ? classes.selected : undefined}`}
      ...
      {activeTool === 'fill' && (
        <div className={classes.sub_tool_wrap}>
          ...
          >
            <span
              className={`${classes.palette} ${fill === '#ffffff' ? classes.selected : undefined}`}
          ...
          >
            <span
              className={`${classes.palette} ${fill === '#ffdddf' ? classes.selected : undefined}`}
              style={{ backgroundColor: '#ff0000' }}
            />
          </button>
          <button
          ...
          >
            <span
              className={`${classes.palette} ${fill === '#ffffdd' ? classes.selected : undefined}`}
              style={{ backgroundColor: '#ffff00' }}
            />
          </button>
          <button
          ...
          >
            <span
              className={`${classes.palette} ${fill === '#ddffdd' ? classes.selected : undefined}`}
              style={{ backgroundColor: '#007700' }}
            />
          </button>
          <button
          ...
          >
            <span
              className={`${classes.palette} ${fill === '#ccccff' ? classes.selected : undefined}`}
              style={{ backgroundColor: '#0000ff' }}
            />
          </button>
          <button
          ...
          >
            <span
              className={`${classes.palette} ${fill === '#eeccff' ? classes.selected : undefined}`}
              style={{ backgroundColor: '#880088' }}
            />
          </button>
        </div>
